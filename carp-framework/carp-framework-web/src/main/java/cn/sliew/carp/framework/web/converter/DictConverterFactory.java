...
public class DictConverterFactory implements ConverterFactory<String, DictInstance> {
    ...
    @Override
    public <T extends DictInstance> Converter<String, T> getConverter(Class<T> targetType) {
        return CACHE.computeIfAbsent(targetType, key -> new DictConverter(targetType));
    }
}
