...
public enum CarpWorkflowTaskInstanceStage implements DictInstance {
    ...
    public static CarpWorkflowTaskInstanceStage of(String value) {
        return Arrays.stream(values())
                ...
                .findAny().orElseThrow(() -> new EnumConstantNotPresentException(CarpWorkflowTaskInstanceStage.class, value));
    }
    ...
    CarpWorkflowTaskInstanceStage(String value, String label) {
        this.value = value;
        this.label = label;
    }
