...
import static cn.sliew.carp.framework.common.reflection.JobDetailsGeneratorUtils.toFQClassName;
...
public class ANewArrayOperandInstruction extends VisitTypeInstruction {
    ...
    public Object invokeInstruction() {
        ...
        return Array.newInstance(ReflectionUtils.toClass(toFQClassName(type)), arraySize);
    }
}
