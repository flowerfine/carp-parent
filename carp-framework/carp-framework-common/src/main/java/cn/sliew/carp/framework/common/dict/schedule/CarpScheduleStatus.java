...
public enum CarpScheduleStatus implements DictInstance {
    ...
    @JsonCreator
    public static CarpScheduleStatus of(String value) {
        return Arrays.stream(values())
                .filter(instance -> instance.getValue().equals(value))
                .findAny().orElseThrow(() -> new EnumConstantNotPresentException(CarpScheduleStatus.class, value));
    }
    ...
    CarpScheduleStatus(String value, String label) {
        this.value = value;
        this.label = label;
    }
