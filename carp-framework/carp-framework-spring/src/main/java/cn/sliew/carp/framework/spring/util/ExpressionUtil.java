...
public enum ExpressionUtil {
    ...
    public static <T> T evaluate(Map<String, Object> params,
                                 String expression,
                                 Class<T> resultClass) throws SpelExpressionException {
        try {
            StandardEvaluationContext context = new StandardEvaluationContext();
            context.setVariables(params);
            return EXPRESSION_CACHE.get(expression).getValue(context, resultClass);
        } catch (Exception e) {
            throw new SpelExpressionException(e, expression, params, resultClass);
        }
    }
