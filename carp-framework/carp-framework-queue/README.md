...
* Redis。基于 Redis 实现延迟队列
  ...
  * [orca](https://github.com/spinnaker/orca)。或者 [spinnaker](https://github.com/spinnaker/spinnaker/tree/main/orca)
  ...
  * [conductor](https://github.com/conductor-oss/conductor)
    * [QueueDAO](https://github.com/conductor-oss/conductor/blob/main/core/src/main/java/com/netflix/conductor/dao/QueueDAO.java)
      ...
      * [PostgresQueueDAO](https://github.com/conductor-oss/conductor/blob/main/postgres-persistence/src/main/java/com/netflix/conductor/postgres/dao/PostgresQueueDAO.java)
      * [SqliteQueueDAO](https://github.com/conductor-oss/conductor/blob/main/sqlite-persistence/src/main/java/com/netflix/conductor/sqlite/dao/SqliteQueueDAO.java)
      * [DynoQueueDAO](https://github.com/conductor-oss/conductor/blob/main/redis-persistence/src/main/java/com/netflix/conductor/redis/dao/DynoQueueDAO.java)。[dyno-queues](https://github.com/Netflix/dyno-queues)。基于 [dynomite](https://github.com/Netflix/dynomite) 实现的任务队列。
      * [orkes-queues](https://github.com/orkes-io/orkes-queues)
    * [ObservableQueue](https://github.com/conductor-oss/conductor/blob/main/core/src/main/java/com/netflix/conductor/core/events/queue/ObservableQueue.java)
      * [AMQPObservableQueue](https://github.com/conductor-oss/conductor/blob/main/amqp/src/main/java/com/netflix/conductor/contribs/queue/amqp/AMQPObservableQueue.java)
      * [SQSObservableQueue](https://github.com/conductor-oss/conductor/blob/main/awssqs-event-queue/src/main/java/com/netflix/conductor/sqs/eventqueue/SQSObservableQueue.java)
      * [KafkaObservableQueue](https://github.com/conductor-oss/conductor/blob/main/kafka-event-queue/src/main/java/com/netflix/conductor/kafkaeq/eventqueue/KafkaObservableQueue.java)
      * nats。
        * [NATSObservableQueue](https://github.com/conductor-oss/conductor/blob/main/nats-streaming/src/main/java/com/netflix/conductor/contribs/queue/stan/NATSObservableQueue.java)
        * [NATSStreamObservableQueue](https://github.com/conductor-oss/conductor/blob/main/nats-streaming/src/main/java/com/netflix/conductor/contribs/queue/stan/NATSStreamObservableQueue.java)
