...
public interface CarpDagOrcaPipelineStageConvert extends BaseConvert<CarpDagOrcaPipelineStage, CarpDagOrcaPipelineStageDTO> {
    CarpDagOrcaPipelineStageConvert INSTANCE = Mappers.getMapper(CarpDagOrcaPipelineStageConvert.class);

    @Override
    default CarpDagOrcaPipelineStage toDo(CarpDagOrcaPipelineStageDTO dto) {
    ...
    @Override
    default CarpDagOrcaPipelineStageDTO toDto(CarpDagOrcaPipelineStage entity) {
