...
public interface DagConfigStepService extends IService<DagConfigStep> {
    ...
    boolean update(DagConfigStepDTO stepDTO);

    void upsert(DagConfigStepDTO stepDTO);

    boolean deleteByDag(Long dagId);

    boolean deleteByDag(List<Long> dagIds);

    boolean deleteSurplusSteps(Long dagId, List<String> stepIds);
