...
public interface RemoteExtensionResponse {
    ...
    /**
     * Default no-op response such that implementing {@link RemoteExtensionTransport#read} and {@link RemoteExtensionTransport#write}
     * are optional.
     */
    @JsonTypeName("noOpResponse")
    class NoOpRemoteExtensionResponse implements RemoteExtensionResponse {
    }
}
