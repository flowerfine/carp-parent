...
/**
 * An application event listener for Carp events that can be utilized by plugins.
 *
 * @param <E> the type of event the listener is for
 */
@FunctionalInterface
public interface CarpEventListener<E extends CarpApplicationEvent>
        extends CarpExtensionPoint {
