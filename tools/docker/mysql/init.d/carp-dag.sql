...
insert into `carp_dag_config` (`id`, `namespace`, `type`, `name`, `uuid`, `dag_meta`, `dag_attrs`, `intput_options`,
...
insert into `carp_dag_config` (`id`, `namespace`, `type`, `name`, `uuid`, `dag_meta`, `dag_attrs`, `intput_options`,
                               `output_options`, `version`, `remark`, `creator`, `editor`)
values (7, 'default', 'WorkFlow', 'Demo', 'fssxbe099903bf174c11bf64b0d486383784', null, '{"foo":"bar"}', null, null, 0,
        null, 'sys', 'sys');
insert into `carp_dag_config` (`id`, `namespace`, `type`, `name`, `uuid`, `dag_meta`, `dag_attrs`, `intput_options`,
                               `output_options`, `version`, `remark`, `creator`, `editor`)
...
values (1, 'default', 1, '157f118c-9b6c-4d18-a919-fce824676696', 'Jdbc Source', 520, 150, null, null,
...
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (2, 'default', 1, 'e69dbf5a-76ad-47be-aa16-175b733a7df2', 'Jdbc Sink', 460, 400, null, null,
...
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (3, 'default', 2, '6223c6c3-b552-4c69-adab-5300b7514fad', 'Fake Source', 380, 140, null, null,
...
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (4, 'default', 2, 'f08143b4-34dc-4190-8723-e8d8ce49738f', 'Console Sink', 360, 290, null, null,
        '{"name":"Console","type":"sink","engine":"seatunnel"}', '{"stepTitle":"Console Sink"}', 'sys', 'sys');
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (5, 'default', 3, '1d0b15ba-12b9-4698-ab21-4c5cfe0b2e64', 'MySQL Source', 380, 140, null, null,
        '{\"name\":\"MySQL\",\"type\":\"source\"}', '{\"stepTitle\":\"MySQL Source\"}', 'sys', 'sys');
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (6, 'default', 3, '640069cb-4f12-4c84-aefb-2731d4a82d78', 'Doris Sink', 360, 290, null, null,
        '{\"name\":\"Doris\",\"type\":\"sink\"}', '{\"stepTitle\":\"Doris Sink\"}', 'sys', 'sys');
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (7, 'default', 4, '7f7ced76-7771-4870-91d9-435ef1c4e623', 'FlinkSessionClusterStatus', 460, 400, null, null,
        '{\"handler\":\"cn.sliew.scaleph.application.flink.action.FlinkSessionClusterStatusSyncJob\",\"type\":\"1\"}',
        null, 'sys', 'sys');
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (8, 'default', 5, '5d5d67c5-ade3-4005-a0db-d514bf11616d', 'FlinkJobStatus', 460, 400, null, null,
        '{\"handler\":\"cn.sliew.scaleph.application.flink.action.FlinkJobStatusSyncJob\",\"type\":\"1\"}', null,
        'sys', 'sys');
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (9, 'default', 6, '8c7b171c-f232-4b96-b842-5f4fbef34bc1', 'DorisOperatorInstanceStatus', 460, 400, null, null,
...
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (14, 'default', 8, 'cfddc076-db37-41b1-a0f5-26430184805d', 'Kafka Source', 640, 160, null, null,
...
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (15, 'default', 8, '8ababac2-725c-46c4-96b7-75ebc94621db', 'Elasticsearch Sink', 640, 334, null, null,
...
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (16, 'default', 8, 'c2e9413a-3aa8-4e04-82ec-77da8f6c12eb', 'Kafka Source', 210, 160, null, null,
        '{\"name\":\"Kafka\",\"type\":\"source\",\"engine\":\"seatunnel\"}',
...
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (17, 'default', 8, '7cc271ae-d7e9-4d8c-8568-c2a50492ab77', 'Kafka Sink', 210, 334, null, null,
...
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (18, 'default', 9, '297d303d-faa8-4405-b104-b438847e35c9', 'MySQL-CDC Source', 370, 110, null, null,
...
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (19, 'default', 9, 'b125d246-a5ae-44cb-8280-ee4f8bfe9f1e', 'Kafka Sink', 370, 250, null, null,
        '{\"name\":\"Kafka\",\"type\":\"sink\",\"engine\":\"seatunnel\"}',
...
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (20, 'default', 10, '65a74232-1d62-4a48-951c-606c62c4bc20', 'MySQL-CDC Source', 430, 190, null, null,
        '{\"name\":\"MySQL-CDC\",\"type\":\"source\",\"engine\":\"seatunnel\"}',
        '{\"stepTitle\":\"MySQL-CDC Source\",\"base-url\":\"jdbc:mysql://localhost:3306/data_service\",\"username\":\"root\",\"password\":\"123456\",\"table-names\":\"data_service.sample_data_e_commerce\",\"startupMode\":\"initial\",\"stopMode\":\"never\",\"snapshot.split.size\":8096,\"snapshot.fetch.size\":1024,\"incremental.parallelism\":1,\"server-time-zone\":\"UTC\",\"connection.pool.size\":20,\"connect.timeout\":\"30s\",\"connect.max-retries\":3,\"chunk-key.even-distribution.factor.lower-bound\":0.05,\"chunk-key.even-distribution.factor.upper-bound\":1000,\"sample-sharding.threshold\":1000,\"inverse-sampling.rate\":1000,\"exactly_once\":true,\"format\":\"DEFAULT\",\"debezium\":\"{}\"}',
        'sys', 'sys');
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (21, 'default', 10, '75e6ddb1-5146-46c1-9cfe-39f3a1be196a', 'Paimon Sink', 430, 325, null, null,
...
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (22, 'default', 11, 'ffa948e5-d728-4b1a-abb1-b4058f353118', 'MySQL-CDC Source', 380, 40, null, null,
        '{\"name\":\"MySQL-CDC\",\"type\":\"source\",\"engine\":\"seatunnel\"}',
        '{\"stepTitle\":\"MySQL-CDC Source\",\"base-url\":\"jdbc:mysql://localhost:3306/data_service\",\"username\":\"root\",\"password\":\"123456\",\"table-names\":\"data_service.sample_data_e_commerce\",\"startupMode\":\"initial\",\"stopMode\":\"never\",\"snapshot.split.size\":8096,\"snapshot.fetch.size\":1024,\"incremental.parallelism\":1,\"server-time-zone\":\"UTC\",\"connection.pool.size\":20,\"connect.timeout\":\"30s\",\"connect.max-retries\":3,\"chunk-key.even-distribution.factor.lower-bound\":0.05,\"chunk-key.even-distribution.factor.upper-bound\":1000,\"sample-sharding.threshold\":1000,\"inverse-sampling.rate\":1000,\"exactly_once\":true,\"format\":\"DEFAULT\",\"debezium\":\"{}\"}',
        'sys', 'sys');
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (23, 'default', 11, '6faa1187-093e-4a1f-867c-ebe5c6ed1251', 'Kafka Sink', 380, 163, null, null,
        '{\"name\":\"Kafka\",\"type\":\"sink\",\"engine\":\"seatunnel\"}',
...
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (24, 'default', 11, '66e6337a-e9e3-49ff-90ae-28672147c938', 'Kafka Source', 380, 266, null, null,
        '{\"name\":\"Kafka\",\"type\":\"source\",\"engine\":\"seatunnel\"}',
...
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (25, 'default', 11, 'ed9c7440-e6b6-47c7-bf97-1051392174eb', 'Doris Sink', 380, 383, null, null,
...
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (26, 'default', 12, '1a7dc268-5620-4f17-974a-8b22e51690a5', 'MySQL-CDC Source', 420, 80, null, null,
        '{\"name\":\"MySQL-CDC\",\"type\":\"source\",\"engine\":\"seatunnel\"}',
        '{\"stepTitle\":\"MySQL-CDC Source\",\"base-url\":\"jdbc:mysql://localhost:3306/data_service\",\"username\":\"root\",\"password\":\"123456\",\"table-names\":\"data_service.sample_data_e_commerce\",\"startupMode\":\"initial\",\"stopMode\":\"never\",\"snapshot.split.size\":8096,\"snapshot.fetch.size\":1024,\"incremental.parallelism\":1,\"server-time-zone\":\"UTC\",\"connection.pool.size\":20,\"connect.timeout\":\"30s\",\"connect.max-retries\":3,\"chunk-key.even-distribution.factor.lower-bound\":0.05,\"chunk-key.even-distribution.factor.upper-bound\":1000,\"sample-sharding.threshold\":1000,\"inverse-sampling.rate\":1000,\"exactly_once\":true,\"format\":\"DEFAULT\",\"debezium\":\"{}\"}',
        'sys', 'sys');
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (27, 'default', 12, '763e5f0a-fea0-400b-a5d0-42f72fed63f9', 'Iceberg Sink', 420, 210, null, null,
...
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (28, 'default', 13, '01JJASC5NXJZXVNXV4H49V0590', 'Log', 420, 80, null, null,
        '{\"type\":\"log\",\"syntheticStageOwner\":null,\"additionalMetricTags\":{}}',
        '{\"stepTitle\":\"log\",\"context\":{\"url\":\"url-data\",\"payload\":\"payload-data\"}}', 'sys', 'sys');
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (29, 'default', 13, '01JJASQN1A3AX87TCZ3PYKGY6M', 'Wait', 420, 210, null, null,
...
insert into `carp_dag_config_step` (`id`, `namespace`, `dag_id`, `step_id`, `step_name`, `position_x`, `position_y`,
                                    `shape`, `style`, `step_meta`, `step_attrs`, `creator`, `editor`)
values (30, 'default', 13, '01JJASWEDS856T5G4A330ZT63G', 'Log', 420, 340, null, null,
        '{\"type\":\"log\",\"syntheticStageOwner\":null,\"additionalMetricTags\":{}}',
        '{\"stepTitle\":\"log\",\"context\":{\"url\":\"url-data\",\"payload\":\"payload-data\"}}', 'sys', 'sys');
